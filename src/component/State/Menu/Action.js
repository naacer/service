...
import { CREATE_MENU_ITEM_FAILURE, CREATE_MENU_ITEM_REQUEST, CREATE_MENU_ITEM_SUCCESS, DELETE_MENU_ITEM_FAILURE, DELETE_MENU_ITEM_REQUEST, DELETE_MENU_ITEM_SUCCESS, GET_ITEMS_BY_RESTAURANT_ID_FAILURE, GET_ITEMS_BY_RESTAURANT_ID_REQUEST, GET_ITEMS_BY_RESTAURANT_ID_SUCCESS, SEARCH_MENU_ITEM_FAILURE, SEARCH_MENU_ITEM_REQUEST, SEARCH_MENU_ITEM_SUCCESS, UPDATE_MENU_ITEMS_AVAILABILITY_FAILURE, UPDATE_MENU_ITEMS_AVAILABILITY_REQUEST, UPDATE_MENU_ITEMS_AVAILABILITY_SUCCESS } from "./ActionType";
    ...
    return async(dispatch) =>  {
        ...
        try {
            const{data}=await api.put(`/api/admin/food/${foodId}`,{},
              ...
              console.log("update menyItems availability Menu",data);
...
export const deleteFoodAction=({foodId,jwt})=>{
    return async(dispatch) =>  {
        ...
        try {
            ...
            console.log("error",error);
            dispatch({type:DELETE_MENU_ITEM_FAILURE,payload:foodId})
