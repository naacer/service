...
const menuItemReducer = (state = initialState , action)=>{
    switch (action.type) {
        ...
        case actionTypes.GET_ITEMS_BY_RESTAURANT_ID_REQUEST:
        ...
        case actionTypes.GET_ITEMS_BY_RESTAURANT_ID_SUCCESS:
            return{
                ...state,
                loading:false,
        ...
        case actionTypes.GET_ITEMS_BY_RESTAURANT_ID_FAILURE:
