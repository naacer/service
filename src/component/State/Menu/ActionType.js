...
export const GET_ITEMS_BY_RESTAURANT_ID_REQUEST= 'GET_ITEMS_BY_RESTAURANT_ID_REQUEST';
export const GET_ITEMS_BY_RESTAURANT_ID_SUCCESS= 'GET_ITEMS_BY_RESTAURANT_ID_SUCCESS';
export const GET_ITEMS_BY_RESTAURANT_ID_FAILURE= 'GET_ITEMS_BY_RESTAURANT_ID_FAILURE';
...
export const SEARCH_MENU_ITEM_REQUEST= 'CREATE_MENU_ITEM_REQUEST';
export const SEARCH_MENU_ITEM_SUCCESS= 'CREATE_MENU_ITEM_SUCCESS';
export const SEARCH_MENU_ITEM_FAILURE= 'CREATE_MENU_ITEM_FAILURE';
