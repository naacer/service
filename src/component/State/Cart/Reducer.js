...
const cartReducer =(state= initialState, action)=> {
    switch (action.type){
        ...
        case actionTypes.UPDATE_CARTIEM_REQUEST:
        ...
        case  actionTypes.ADD_ITEMS_TO_CART_SUCCESS:
            return {
                ...state,
                loading: false,
                cartItems: state.cartItems ? [action.payload, ...state.cartItems] : [action.payload],
            };
        case actionTypes.UPDATE_CARTIEM_SUCCESS:
            return {
                ...state,
                loading: false,
        ...
        case actionTypes.UPDATE_CARTIEM_FAILURE:
