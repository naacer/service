...
import { getIngerdientsOfRestaurant, updateStockOfIngredients } from '../../component/State/Ingredients/Action';
...
const IngredientTable = () => {
    ...
    useEffect(()=>{
        dispatch(
            getIngerdientsOfRestaurant({jwt,id:restaurant.usersRestaurant.id}))
    }, [])

    const handleUpdateStoke=(id)=>{
        dispatch(updateStockOfIngredients({id,jwt}))
    }
    return (
        <Box>
            <Card className='mt-1'>
