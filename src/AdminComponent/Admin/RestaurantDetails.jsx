...
import { updateRestauranStatus } from '../../component/State/Restaurant/Action';
...
dispatch(updateRestauranStatus({
              ...
              <div className='space-y-4 text-gray-200'>
                ...
                <div className='flex'>
                 ...
                 <div className='flex text-gray-400 items-center pb-4 gap-2'>
                  ...
                  <a href={restaurant.usersRestaurant?.contactInformation?.tiwtter}>
